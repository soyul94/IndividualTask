...
public class ReviewController {
	...
	public String BoardSelect(@ModelAttribute("searchVO")ReviewVO reviewVO, HttpServletRequest request, ModelMap model)
			throws Exception {
	...
	public String reviewRegist(@ModelAttribute("searchVO")ReviewVO reviewVO, HttpServletRequest request, ModelMap model) throws Exception {
